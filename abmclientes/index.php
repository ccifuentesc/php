...
if (isset($_GET["do"]) && $_GET["do"] == "eliminar") {
    ...
    // Convertir el array en json en el archivo
        ...
        <div class="row">
            <div class="col-6">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        <input type="text" id="txtDni" name="txtDni" class="form-control" required value="<?php echo isset($aClientes[$pos]) ? $aClientes[$pos]["documento"] : ""; ?>">
                    </div>
                    <div>
