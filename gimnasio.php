...
class Alumno extends Persona
{
    ...
    public function FichaMedica($peso, $altura, $aptoFisico)
    {
        $this->peso = $peso;
        $this->altura = $altura;
...
class Clase
{
    ...
    public function imprimirListado()
    {
        ...
        foreach ($this->aAlumnos as $alumno) {
            echo "<tr><td>" . number_format($alumno->documento, 0, ",", ".") . "</td><td>" . $alumno->nombre . "</td><td>" . $alumno->correo . "</td><td>" . $alumno->celular . "</td></tr>";
        }
        echo "</table>";
    }
}
...
//$alumno1->setFichaMedica(70, 169, false);
...
<body>
    <main class="container">
        ...
        <div class="row">
            <div class="col-12">
                <?php $clase1->imprimirListado(); //imprime la clase 1 
                ?>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <?php $clase2->imprimirListado(); //imprime la clase 2 
                ?>
            </div>
        </div>
    </main>
